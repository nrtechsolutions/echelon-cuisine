...
const menuCategories: Record<string, MenuItem[]> = {
  "Vegetarian Starters": [
    ...
    },
    {
      ...
      description: "Fried fritters made with mixed vegetables coated in chickpea batter",
      price: "$6.99",
    ...
    {
      name: "Babycorn 65",
      description: "Deep fried baby corn coated with batter & cooked in Indo-Chinese style",
      price: "$12.99",
    ...
    {
      name: "Paneer 65",
      description: "Paneer Stir Fried with ginger-garlic, yogurt, lime and curry leaves",
      price: "$13.99",
    ...
    {
      name: "Chili Paneer",
      description: "Cottage cheese stir-fried with bell pepper and onions in chili sauce",
      price: "$13.99",
 ...
 "Non-Vegetarian Starters": [
      ...
      {
        name: "Chicken Angara",
        description: "Boneless chicken breast stir-fried with unique spicy flavors sauce",
        price: "$13.99",
      ...
      },
      {
        ...
        description: "Boneless chicken breast stir-fried and cooked with Indian spices",
        price: "$13.99",
      ...
      {
        name: "Chicken 65",
        description: "Boneless chicken thigh stir-fried with ginger-garlic, yogurt, lime and curry leaves",
        price: "$13.99",
      ...
      {
        name: "CHILLI CHICKEN",
        description: "Boneless chicken thigh stir-fried with bell Pepper and onions in chili sauce",
        price: "$13.99",
      ...
      },
      {
        ...
        description: "Boneless chicken thigh stir-fried with roasted curry leaves masala",
        price: "$13.99",
   ...
   [
        ...
        },
        {
          ...
          description: "Grilled chicken tenders (boneless), marinated with fennel and indian spices",
          price: "$12.99",
        ...
        {
          name: "Malai Kebab",
          description: "Boneless chicken marinated with juicy mixture of cream, creamy cheese and cashews and aromatic spices, grilled in an authentic tandoor",
          price: "$14.99",
        ...
        },
        {
          ...
          description: "Grilled paneer and vegetables marinated in lemon, yogurt, garlic and spices",
          price: "$12.99",
  ...
  "Vegetarian Entrées": [
        {
          name: "Aloo Gobi",
          description: "Potatoes and cauliflower florets cooked in a savory onion and ginger-garlic sauce.",
          price: "$15.99",
        ...
        {
          name: "Navratan Korma",
          description: "Rich and creamy dish that literally translates to nine-gem korma.",
          price: "$15.99",
        ...
        {
          name: "Chana Masala",
          description: "Boiled chickpeas cooked in a deep-roasted, tomato-onion gravy.",
          price: "$15.99",
        ...
        },
        {
          ...
          description: "Pan-seared vegetables cooked with roasted onions and tomatoes.",
          price: "$15.99",
        ...
        },
        {
          ...
          description: "Cottage cheese cooked with roasted spices, onions, tomatoes and cream, with a touch of fenugreek.",
          price: "$16.99",
        ...
        {
          name: "Bagare Baingan",
          description: "Bagare baigan is a traditional curried eggplant dish from Hyderabad.",
          price: "$16.99",
        ...
        {
          name: "Saag Paneer",
          description: "Cottage cheese and spinach slow-cooked in an onion-based ginger-garlic sauce.",
          price: "$16.99",
  ...
  "Non-vegetarian Entrées": [
        {
          ...
          description: "Boneless chicken breast cooked with roasted spices, onions, tomato sauce, bell peppers, cashew nut paste and cream.",
          price: "$16.99",
          image: "/charminar_logo.png",
          isHalal: true,
        },
        {
          name: "Butter Chicken",
          description: "Boneless chicken thigh cooked with roasted spices, tomato sauce, cashew nut paste & cream.",
          price: "$16.99",
          image: "/charminar_logo.png",
          isHalal: true,
        },
        {
          name: "Dum Ka Chicken",
          description: "Slow-cooked chicken curry made with spice-marinated onions, ginger-garlic, tomatoes and nuts, originally created in the royal courts of Hyderabad.",
          price: "$16.99",
          image: "/veg/dkc.jpg",
          isHalal: true,
        },
        {
          ...
          description: "Chicken ghee roast is a fiery and spicy dish with a flavor of ghee roasted spices.",
          price: "$16.99",
          image: "/charminar_logo.png",
          isHalal: true,
        },
        ...
        {
          name: "Chicken Sukka",
          description: "Chicken marinated in Indian spices, cooked on a low flame until spices are thoroughly soaked up.",
          price: "$16.99",
          image: "/veg/sukka.jpg",
          isHalal: true,
        },
        {
          ...
          description: "Chicken marinated in yogurt, turmeric, red chilies and unique Chettinad spices and oils.",
          price: "$16.99",
        ...
        {
          name: "Kadai Goat",
          description: "Pan-seared meat cooked with roasted onions, bell peppers, and tomatoes.",
          price: "$18.99",
          image: "/charminar_logo.png",
          isHalal: true,
        },
        {
          name: "Goat Sukka",
          description: "Goat cubes marinated in Indian spices, cooked on a low flame until spices are thoroughly soaked up.",
          price: "$18.99",
        ...
        },
        {
          ...
          description: "Goat ghee roast is a fiery and spicy dish with a flavor of ghee roasted spices.",
          price: "$18.99",
          image: "/charminar_logo.png",
          isHalal: true,
        },
        ...
        {
          name: "Goat Chettinad",
          description: "Goat meat marinated in yogurt, turmeric, red chilies and unique Chettinad spices and oils.",
          price: "$18.99",
          image: "/charminar_logo.png",
          isHalal: true,
        },
        ...
        {
          name: "Egg Ghee Roast",
          description: "Egg ghee roast is a fiery and spicy dish with a flavor of ghee roasted spices.",
          price: "$16.99",
          image: "/charminar_logo.png",
          isHalal: true,
        }
  ...
  "Charminar Biryanis": [
      {
        ...
        description: "Aromatic, succulent goat meat in layers of fluffy rice, fragrant spices, and caramelized onions. Available on Fri, Sat & Sun only.",
        price: "$19.99 (Regular 32 OZ), $30.99 (Family 58 OZ), $64.99 (Bucket 120 OZ)",
        image: "/charminar_logo.png",
        isHalal: true
      },
     {
       name: "Hyderabadi Chicken Dum Biryani",
       description: "Aromatic chicken biryani with layers of rice and fragrant spices.",
       price: "$17.99 (Regular 32 OZ), $29.99 (Family 58 OZ), $59.99 (Bucket 120 OZ)",
       image: "/veg/CHICKEN BIRYANI-01.jpg",
       isHalal: true
     },
     {
       name: "Chicken 65 Biryani (Boneless)",
       description: "Boneless chicken biryani with a twist of Chicken 65 spices.",
       price: "$18.99 (Regular 32 OZ), $29.99 (Family 58 OZ), $59.99 (Bucket 120 OZ)",
       image: "/charminar_logo.png",
       isHalal: true
     },
     {
     ...
     },
     {
       ...
       description: "Aromatic vegetable biryani with spices and caramelized onions. Available on Fri, Sat & Sun only.",
       price: "$18.99 (Regular 32 OZ), $29.99 (Family 58 OZ), $59.99 (Bucket 120 OZ)",
     ...
     },
     {
       ...
       price: "$18.99 (Regular 32 OZ), $30.99 (Family 58 OZ), $59.99 (Bucket 120 OZ)",
     ...
     {
       name: "Fish Biryani",
       description: "Delicious fish biryani with layers of fragrant rice and spices.",
       price: "$19.99 (Regular 32 OZ), $30.99 (Family 58 OZ), $64.99 (Bucket 120 OZ)",
       image: "/charminar_logo.png",
       isHalal: true
     }
  ...
  "Fresh Tandoor Breads": [
    {
        name: "Tandoori Roti",
        description: "Whole-wheat, unleavened Indian bread cooked in a tandoor oven.",
        price: "$3.99",
        image: "/charminar_logo.png",
        isHalal: true
      },
      {
        name: "Butter Roti",
        description: "Butter-infused, whole-wheat, unleavened Indian bread cooked in a tandoor oven.",
        price: "$3.99",
        image: "/charminar_logo.png",
        isHalal: true
      },
      ...
      {
        name: "Butter Naan",
        description: "Butter-infused, teardrop-shaped, leavened bread baked in a tandoor oven.",
        price: "$3.99",
        image: "/charminar_logo.png",
        isHalal: true
      },
      {
        name: "Garlic Naan",
        description: "Garlic and herb-infused, teardrop-shaped, leavened bread baked in a tandoor oven.",
        price: "$3.99",
      ...
      },
      {
        ...
        description: "Chili-Garlic infused, teardrop-shaped, leavened bread baked in a tandoor oven.",
        price: "$3.99",
        image: "/charminar_logo.png",
        isHalal: true
      },
      {
        name: "Cheese Naan",
        description: "Buttery leavened bread baked in a tandoor oven, stuffed with cottage cheese and seasoned with Indian spices.",
        price: "$3.99",
        image: "/charminar_logo.png",
        isHalal: true
      }
