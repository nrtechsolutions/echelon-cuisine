...
export default function Catering() {
  return (
    <div
      ...
      style={{
        backgroundImage: "url('/biryani_home.jpg')",
    ...
    >
      ...
      <div className="max-w-screen-lg mx-auto p-4 md:p-8 bg-black rounded-lg shadow-lg transition-all duration-300 hover:bg-gray-900 text-center mb-12">
        <p className="text-lg text-gray-300 mb-8 text-left md:text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center md:space-x-6 space-y-4 md:space-y-0 gap-4">
          <Link href="/catering-menu">
            <span className="bg-gold text-black px-6 py-3 rounded-lg shadow-md hover:bg-yellow-500 hover:text-white transition duration-300 w-full md:w-auto text-center">
              View Catering Menu
            </span>
          </Link>
          <Link href="/contact">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 max-w-screen-lg mx-auto mb-12">
      ...
      <div className="max-w-screen-lg mx-auto p-4 md:p-8 bg-black rounded-lg shadow-lg transition-all duration-300 hover:bg-gray-900 text-center">
